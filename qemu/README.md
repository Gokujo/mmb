...
To get started, build 64-bit custom image using Pieman or download one of the existing images from other projects (for example, you may find the 64-bit Gentoo image on [this page](https://github.com/sakaki-/gentoo-on-rpi3-64bit#gentoo-on-rpi3-64bit)).

Let's say the filename of the image is `ubuntu-artful-arm64-for-rpi3.img`. To run the image in the emulator, execute the following command:

```
./docker-qemu.sh -e IMAGE=ubuntu-artful-arm64-for-rpi3.img
```
...
```
/sbin/fdisk -lu ubuntu-artful-arm64-for-rpi3.img
```
...
ubuntu-artful-arm64-for-rpi3.img1        8192  204800  196609   96M  c W95 FAT32 (LBA)
ubuntu-artful-arm64-for-rpi3.img2      206651 8388607 8181957  3.9G 83 Linux
```
...
```
sudo mount -o loop,offset=$((8192 * 512)) ubuntu-artful-arm64-for-rpi3.img /mnt/
```
...
./docker-qemu.sh \
    ...
    -e MEMORY=1G \
    -e SD=ubuntu-artful-arm64-for-rpi3.img \
